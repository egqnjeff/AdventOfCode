...
public class Day9_2 {
    // private static String inputPath = "2023/Java/resource/Day9/test.txt";
    private static String inputPath = "2023/Java/resource/Day9/input.txt";
